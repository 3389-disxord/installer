<h1 align="center">3389-disxord Installer</h1>
...
<p align="center">
  ...
  <br/>
  A simple standalone program which automates the installation, removal and maintenance of <a href="https://github.com/3389-disxord/3389-disxord">3389-disxord</a>.
  <br/>
  <br/>
...
This repository contains the source code for the 3389-disxord installer. This installer is written with [electron-webpack](https://webpack.electron.build/) and [Svelte 3](https://svelte.dev/).

## Downloads

These will link you to the latest builds found in the [releases](https://github.com/3389-disxord/installer/releases/) tab of this repository.

| [Windows (7+)](https://github.com/3389-disxord/Installer/releases/latest/download/3389-disxord-Windows.exe)  | [macOS (10.10+)](https://github.com/3389-disxord/Installer/releases/latest/download/3389-disxord-Mac.zip) | [Linux](https://github.com/3389-disxord/Installer/releases/latest/download/3389-disxord-Linux.AppImage) |
| ------------- | ------------- | ------------- |
...
> This is a tutorial designed for people looking to contribute to, or work directly with the installer's source code. If you are just looking to download and install 3389-disxord, visit the [releases](https://github.com/3389-disxord/installer/releases/) page of this repository.
...
```ps
git clone https://github.com/3389-disxord/installer && cd installer
```
...
<a href="https://github.com/3389-disxord/installer/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=3389-disxord/installer" />
</a>
